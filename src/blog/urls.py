...
from .views import create_article_view, articles_view, detail_article_view, search_article_view, detail_article_hx_view


urlpatterns = [
    path('', articles_view, name="blog_url"),
    path('create/', create_article_view, name="new_aricle_path"),
    path('article/hx/<slug:slug>', detail_article_hx_view, name="article_hx_path"),
